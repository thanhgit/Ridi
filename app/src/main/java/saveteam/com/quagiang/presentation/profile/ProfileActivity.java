...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        birthday.initDateTimePicker("birthday", new DateTimePickerUtils.DateTimeListener() {
            ...
            public void onPositiveButtonClick(Date date, String tagFragment) {
                String sBirthday = DateTimeUtils.getDateFormat().format(date);
        ...
        startTime.initDateTimePicker("start_time", new DateTimePickerUtils.DateTimeListener() {
            @Override
            public void onPositiveButtonClick(Date date, String tagFragment) {
                String sStartTime = DateTimeUtils.getTimeFormat().format(date);
        ...
        leaveOfficeTime.initDateTimePicker("leave_office_time", new DateTimePickerUtils.DateTimeListener() {
            @Override
            public void onPositiveButtonClick(Date date, String tagFragment) {
                String sLeaveOfficeTime = DateTimeUtils.getTimeFormat().format(date);
    ...
    public void clickEditProfile(View view) {
        MyPermission.getInstance(this).requestPermission(ActivityUtils.PROFILE_REQUIRED_PERMISSIONS);
        update = true;
    ...
    public void loadCurrentProfile() {
        ...
        if (mProfile != null) {
            ...
            gender.setHint(mProfile.isGender() ? getResources().getString(R.string.gender_male) :
