...
public class ConfirmFB implements Serializable {
    ...
    @Ignore
    public ConfirmFB(@NonNull String uid, String findRideId, String findRideName, String findRideFromPlace, String findRideToPlace, String offerRideId, String offerRideName, String offerRideFromPlace, String offerRideToPlace, double distance, double cost) {
        this.uid = uid;
        this.findRideId = findRideId;
        this.findRideName = findRideName;
        this.findRideFromPlace = findRideFromPlace;
